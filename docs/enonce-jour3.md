...
👉 Aujourd’hui, l’objectif n’est pas “coder beaucoup”. 👉 L’objectif est de créer un cadre de travail propre qui évite 80% des problèmes plus tard.
...
👉 git add prépare les fichiers pour le commit. Ça ne “sauvegarde” pas encore, ça prépare.
